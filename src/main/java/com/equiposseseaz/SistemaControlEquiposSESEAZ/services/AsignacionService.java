...
import com.equiposseseaz.SistemaControlEquiposSESEAZ.repositories.LicenciaRepository;
...
//  Verificar y guardar personal (LISTA DE PERSONAL)
    ...
    public List<Asignacion> obtenerAsignacionesPorEquipo(ObjectId equipoId) {
